...
#define N_PARMS 31                      //Nb. of parameters passed to the C code (list parms_C in R code)
...
#define NV 3                            //Nb. of vaccination statuses (unvac, vac_neg, vac_pos)
...
/*NB. OF HOST COMPARTMENTS (PER ONE VACCINATION STATUS)*/	
...
static double theta_unvac[NN][NN][NN];
static double psy_DENV1_unvac[N_AGE_GROUPS][NN][NN][NN];
static double psy_DENV2_unvac[N_AGE_GROUPS][NN][NN][NN];
static double psy_DENV3_unvac[N_AGE_GROUPS][NN][NN][NN];
static double psy_DENV4_unvac[N_AGE_GROUPS][NN][NN][NN];
static int past_infections[NN][NN][NN];
static double theta_vac_neg[N_AGE_GROUPS][NS][NN][NN][NN];  
static double theta_vac_pos[N_AGE_GROUPS][NS][NN][NN][NN]; 
static double psy_DENV1_vac_neg[N_AGE_GROUPS][NN][NN][NN];
static double psy_DENV2_vac_neg[N_AGE_GROUPS][NN][NN][NN];
static double psy_DENV3_vac_neg[N_AGE_GROUPS][NN][NN][NN];
static double psy_DENV4_vac_neg[N_AGE_GROUPS][NN][NN][NN];
static double psy_DENV1_vac_pos[N_AGE_GROUPS][NN][NN][NN];
static double psy_DENV2_vac_pos[N_AGE_GROUPS][NN][NN][NN];
static double psy_DENV3_vac_pos[N_AGE_GROUPS][NN][NN][NN];
static double psy_DENV4_vac_pos[N_AGE_GROUPS][NN][NN][NN];
...
/*Position of an element in an array theta for vaccinated & protected hosts */
#define G_ELT5 get_elt_theta_vac
int get_elt_theta_vac(int i, int s, int j, int k, int l);

/*Position of an element in an array psy for vaccinated & protected hosts (dimensions N_AGE_GROUPS x NN x NN x NN) */
#define G_ELT6 get_elt_psy_vac
