...
ResultsEpi_ApplySeverities<-function(nb_inf_5D_by_year,      #Array with the number of infections --> 5D array (year, age, serotype, infection type, vac status)
  ...
  #------------------------------------------------------------------------------- #Initializing a new 6D object with the number of infections by 1/ simulation year, 2/age,
  #---- Initialize a new object -------------------------------------------------- 3/serotype, 4/type, 5/vaccination status and 6/severity
  #-------------------------------------------------------------------------------
  ...
  #-------------------------------------------------------------------------------
  #---- Calculate % hospitalisations that are severe and mild --------------------
  #-------------------------------------------------------------------------------
  #Proportion of hospitalizaitons that are severe
  ...
  #Proportion of hospitalized infections that are mild
  prop_mild_hospit<-1-prop_severe_hospit                                                                                   
    
  #-------------------------------------------------------------------------------   #For unvaccinated hosts the proportion of each outcome (severity) of interest can be calculated from 
  #---- Unvaccinated hosts -------------------------------------------------------   the model inputs (which were previously manipulated and stored in the object prop_sympt_unvac, prop_severe_sympt_unvac etc.)
  #-------------------------------------------------------------------------------   Calculation for vaccinated hosts is provided further below
  ...
  #Aggregating into an array where dimension are: severity level, serotype & the infection type
  p_sev_level<-array(NA, dim= c(6,parms_gen$N_age_groups,4,3))
  for(year in 1:parms_gen$timeframe){
    nb_inf_6D_by_year[year,,,,1,1]<-nb_inf_5D_by_year[year,,,,1]*p_asympt                    #Asymptomatic 
    nb_inf_6D_by_year[year,,,,1,2]<-nb_inf_5D_by_year[year,,,,1]*p_mild_non_hosp             #Symptomatic, mild, non-hospitalised
    nb_inf_6D_by_year[year,,,,1,3]<-nb_inf_5D_by_year[year,,,,1]*p_mild_hosp                 #Symptomatic, mild, hospitalised  
    nb_inf_6D_by_year[year,,,,1,4]<-nb_inf_5D_by_year[year,,,,1]*p_severe_non_hosp           #Symptomatic, severe, non-hospitalised    
    nb_inf_6D_by_year[year,,,,1,5]<-nb_inf_5D_by_year[year,,,,1]*p_severe_hosp_non_fatal     #Symptomatic, severe, hospitalised, non-fatal
    nb_inf_6D_by_year[year,,,,1,6]<-nb_inf_5D_by_year[year,,,,1]*p_severe_hosp_fatal         #Symptomatic, severe, hospitalised, fatal
  }   
  
  #-------------------------------------------------------------------------------  #For vaccinated individuals, the proportion of each outcome (severity) depends on the underlying proportions (without vaccination) and on vaccine efficacy
  #---- Vaccinated hosts (if vaccine is included) --------------------------------  #These proportions were calculated, at each simulation year, in the function ParmsVacEff_GetSevDistr (script "22_parms_vac_eff.R")
  #-------------------------------------------------------------------------------  #As the simulation progressed, the values for each year were stored in larger arrays (prop_asympt_vac, prop_sympt_vac etc.), which are used below
