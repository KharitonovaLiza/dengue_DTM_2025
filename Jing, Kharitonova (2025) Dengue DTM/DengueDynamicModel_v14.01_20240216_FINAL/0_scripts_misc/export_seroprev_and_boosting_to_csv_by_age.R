...
ref_scen_wo_vac<-"Scen_00001"         #Reference of a scenario without vaccination
ref_scen_with_vac<-"Scen_001291"       #Reference of a scenario with vaccination 
...
seroprev_in_all_cohorts_wo_vac_final_by_age  <-matrix(NA, nrow=101, ncol=5)    #One row per year, one column per serostatus
seroprev_in_all_cohorts_with_vac_final_by_age <-matrix(NA, nrow=101, ncol=5)
...
seroprev_in_all_cohorts_wo_vac_final_by_age  <-apply(seroprev_wo_vac_avg  [,,,drop=F],c(2,3),mean)   #Mean across time horizon by age
seroprev_in_all_cohorts_with_vac_final_by_age <-apply(seroprev_with_vac_avg[,,,drop=F],c(2,3),mean)
...
colnames(seroprev_in_all_cohorts_wo_vac_final_by_age)  <-c("naive", "history_of_1inf", "history_of_2inf", "history_of_3inf", "history_of_4inf")
colnames(seroprev_in_all_cohorts_with_vac_final_by_age)<-c("naive", "history_of_1inf", "history_of_2inf", "history_of_3inf", "history_of_4inf")
...
write.csv(seroprev_in_all_cohorts_wo_vac_final_by_age,   file=file.path(path_results_export, paste(ref_scen_wo_vac,   "_seroprev_in_all_cohorts_by_age.csv", sep="")), row.names=TRUE)
write.csv(seroprev_in_all_cohorts_with_vac_final_by_age, file=file.path(path_results_export, paste(ref_scen_with_vac, "_seroprev_in_all_cohorts_by_age.csv", sep="")), row.names=TRUE)
